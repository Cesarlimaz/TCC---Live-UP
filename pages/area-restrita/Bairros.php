...
<body>
	...
	<div class="contact1">
		<div class="container-contact1">
			...
			<form class="contact1-form validate-form" method="post" action="cadastro-bairro.php">
				...
				<div class="wrap-input1 validate-input">
                    <input class="input1" name="Nomes" placeholder="Nome do bairro"></input>
					<span class="shadow-input1"></span>
				</div>
				<div class="wrap-input1 validate-input">
                    <input class="input1" name="Regioes" placeholder="Região"></input>
					<span class="shadow-input1"></span>
				</div>
