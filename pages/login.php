				...
				<div class="wrap-login100">
					<form class="login100-form validate-form" action="valida-login.php" method="post">
						...
						<span class="login100-form-title p-b-48">
							<i><img class="foto" src="images/logo/logo3.png" /></i>
						</span>
						<div
						...
						>
							...
							<input class="input100" type="text" name="txtlogin" />
							<span
								class="focus-input100"
								data-placeholder="Usuario ADM"
							></span>
						</div>
						...
						<div class="text-center p-t-115">
							...
							<a class="txt2" href="*"> </a>
							<br />
							<span class="txt1">Voltar para </span>
							<a class="txt2" href="index.php"> home </a>
						</div>
					</form>
				</div>
			</div>
